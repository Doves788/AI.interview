          ...
          <div className='text-center mb-28'>
            ...
            <div className='flex flex-wrap justify-center gap-4 mt-10'>
              <motion.button
                ...
                className='bg-black text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-md border border-gray-700'>
                Start Interview
              </motion.button>
              ...
              <motion.button
                ...
                whileHover={{ opacity: 0.9, scale: 1.03 }}
                whileTap={{ opacity: 1, scale: 0.98 }}
                className='bg-white text-black border border-gray-300 px-10 py-3 rounded-full hover:bg-gray-100 transition'>
                View History
              </motion.button>
            </div>
          </div>
